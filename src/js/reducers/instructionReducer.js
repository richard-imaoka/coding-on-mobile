...
export function instruction(state = Map({instructionData: {}, instructionSourceList: List(), instructionSource: "", restartTour: false}), action = undefined){
